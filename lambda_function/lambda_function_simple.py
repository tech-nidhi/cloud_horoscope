"""
Simple CloudHoroscopeFunction - Fallback version without Bedrock dependency
"""
...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        # Generate horoscope
        horoscope = generate_simple_horoscope(name, zodiac_sign)
...
def generate_simple_horoscope(name: str, zodiac_sign: str) -> str:
    """Generate a simple horoscope without AI"""
    horoscopes = {
